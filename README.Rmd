...
<!-- badges: start -->
[![R build status](https://github.com/andrie/sss/workflows/R-CMD-check/badge.svg)](https://github.com/andrie/sss/actions)
...
[triple-s](https://www.triple-s.org/) is a standard to transfer survey data between applications.
