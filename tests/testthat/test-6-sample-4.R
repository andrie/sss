...
filenameSSS <- file.path(sampleRoot, "sample-4.sss")
filenameASC <- file.path(sampleRoot, "sample-4.asc")
...
test_that("parsing of .sss and .asc works", {
  ...
  expect_equal(test$typtel, c("Fixed", "Mobile")[c(1,1,2,2,1,2,1,1,2,2)])
})
